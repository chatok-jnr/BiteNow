          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/80 leading-relaxed">
                Delivering delicious food to your doorstep. Fresh, fast, and always hot!
              </p>
              <div className="flex space-x-3">
                <a href="#" className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-accent-light hover:text-textPrimary transition-all duration-300">
            ...
            {/* Policies */}
            <div>
              <h3 className="text-xl font-bold mb-6 font-display">Legal</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="/privacy-policy" className="text-white/80 hover:text-accent-light transition-all flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-accent-light rounded-full group-hover:w-3 transition-all"></span>
                    <span>Privacy Policy</span>
                  </Link>
                </li>
                <li>
                  <Link to="/terms" className="text-white/80 hover:text-accent-light transition-all flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-accent-light rounded-full group-hover:w-3 transition-all"></span>
                    <span>Terms of Service</span>
                  </Link>
                </li>
                <li>
                  <Link to="/cookies" className="text-white/80 hover:text-accent-light transition-all flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-accent-light rounded-full group-hover:w-3 transition-all"></span>
