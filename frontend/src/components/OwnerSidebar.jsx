...
const OwnerSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3, path: '/restaurant_owner/dashboard' },
    { id: 'restaurants', label: 'All Restaurants', icon: Store, path: '/restaurant_owner/restaurants' },
    { id: 'profile', label: 'Profile', icon: User, path: '/restaurant_owner/profile' }
  ];
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-white/20">
            ...
            <p className="text-white/80 text-sm mt-2">Restaurant Owner</p>
          </div>
          ...
          <div className="p-4 border-t border-white/20">
            <button 
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-white hover:bg-red-500 transition-all"
            >
