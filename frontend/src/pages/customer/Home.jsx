...
import { ChevronLeft, ChevronRight, ShoppingCart, Home as HomeIcon, User, Package, LogOut } from 'lucide-react';
...
import { getCart, addToCart as addToCartAPI, removeFromCart, clearCart } from '../../utils/cartService';
...
const Home = () => {
  ...
  const heroSlides = [
    {
      ...
      description: 'Hot food delivered to your doorstep in under 30 minutes. Your cravings, our priority.'
    },
    {
      image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=1920&q=80',
      title: 'Best Restaurants Near You',
      description: 'Discover top-rated local restaurants and enjoy authentic flavors from your neighborhood.'
    },
    {
      image: 'https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=1920&q=80',
      title: 'Exclusive Discounts Daily',
      description: 'Save big with our daily deals and exclusive offers. Quality food at unbeatable prices.'
    },
    {
      image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1920&q=80',
      title: 'Effortless Ordering Experience',
      description: 'Browse, order, and track your food with our intuitive platform. Food delivery made simple.'
    }
  ];
  ...
  const getSortedRestaurants = () => {
    ...
    switch(sortBy) {
      case 'price-low':
        ...
        return sorted.sort((a, b) => (a.average_price || 0) - (b.average_price || 0));
      case 'price-high':
        return sorted.sort((a, b) => (b.average_price || 0) - (a.average_price || 0));
      case 'date':
      default:
  ...
  const handleAddToCart = async (food) => {
    try {
      ...
      setCartItems(prevItems => {
        const existingItem = prevItems.find(item => item.id === (food._id || food.id));
        if (existingItem) {
          return prevItems.map(item =>
            item.id === (food._id || food.id) ? { ...item, quantity: item.quantity + 1 } : item
          );
        }
        return [...prevItems, { 
          id: food._id || food.id,
  ...
  const handleUpdateQuantity = async (itemId, newQuantity) => {
    try {
      ...
      await addToCartAPI(itemId, newQuantity - (cartItems.find(item => item.id === itemId)?.quantity || 0));
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-primary mb-3">Most Popular Dishes</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-primary mb-3">Explore Restaurants</h2>
          <div className="w-24 h-1 bg-primary mx-auto rounded-full"></div>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            {(restaurantPage + 1) * restaurantsPerPage < sortedRestaurants.length && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <a href="#about" className="text-white hover:text-accent-light transition-colors font-medium">
                About Us
              </a>
              <a href="#contact" className="text-white hover:text-accent-light transition-colors font-medium">
                Contact Us
              </a>
            </div>
