...
import { Clock, MapPin, Star, ShoppingCart, Home as HomeIcon, User, Package, LogOut } from 'lucide-react';
  ...
  const getSortedFoods = () => {
    ...
    switch(sortBy) {
      case 'discount':
        ...
        sortedFoods.sort((a, b) => (b.discount_percentage || 0) - (a.discount_percentage || 0));
        break;
      case 'price-low':
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[500px] overflow-hidden">
        <img 
          src={restaurant.restaurant_image?.url || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1920&q=80'} 
              ...
              <div className="flex flex-wrap gap-6 text-white/90">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-lg">
                    {restaurant.opening_time || '10:00 AM'} - {restaurant.closing_time || '11:00 PM'}
                  </span>
                </div>
                
                <div className="flex items-center space-x-2">
                  <MapPin className="w-5 h-5" />
                  <span className="text-lg">{restaurant.restaurant_address}</span>
                </div>
                
                <div className="flex items-center space-x-2">
                  <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">{restaurant.rating || 4.5}</span>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {sortedFoods.map((food) => (
            <FoodCard 
              ...
              food={{
                ...
                originalPrice: food.discount_percentage > 0 
        ...
        {sortedFoods.length === 0 && (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600">No menu items available at the moment.</p>
          </div>
        )}
      </div>
