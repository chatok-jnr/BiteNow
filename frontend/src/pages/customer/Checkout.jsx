      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
              ...
              {savedAddresses.length === 0 ? (
                <>
                  <div className="text-center py-6 sm:py-8 bg-gray-50 rounded-lg mb-4">
                    ...
                    <button
                      ...
                      className="bg-primary text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full font-semibold hover:bg-accent transition-colors inline-flex items-center gap-2 text-sm sm:text-base"
                    >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-primary text-white px-3 py-2 sm:px-4 rounded-full hover:bg-accent transition-colors text-xs sm:text-sm font-medium"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none text-sm sm:text-base"
              />
            </div>
              ...
              {isEditingContact ? (
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 bg-gray-200 text-gray-700 px-3 py-2 sm:px-4 rounded-full hover:bg-gray-300 transition-colors text-xs sm:text-sm font-medium"
                    >
                      Cancel
                    </button>
                    <button
                      onClick={() => setIsEditingContact(false)}
                      className="flex-1 bg-primary text-white px-3 py-2 sm:px-4 rounded-full hover:bg-accent transition-colors text-xs sm:text-sm font-medium"
                    >
                      Save
                    </button>
                  </div>
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-3 py-2 sm:px-4 rounded-full hover:bg-gray-200 transition-colors text-xs sm:text-sm font-medium"
                  >
                    <Edit className="w-4 h-4" />
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
              ...
              <div className="flex items-center space-x-3 p-3 sm:p-4 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border-2 border-primary">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 lg:sticky lg:top-24">
              <h2 className="text-base sm:text-lg font-semibold text-gray-700 mb-2">
                Your order from
              </h2>
              <p className="text-lg sm:text-xl font-bold text-primary mb-4 sm:mb-6">
                {restaurant?.name || "Restaurant"}
              </p>

              {/* Items List */}
              <div className="space-y-2 sm:space-y-3 mb-4 border-b border-gray-200 pb-4 max-h-64 overflow-y-auto">
                {cart &&
                  cart.items &&
                  cart.items.map((item, index) => (
                    <div
                      key={index}
                      className="flex justify-between items-start p-2 hover:bg-gray-50 rounded-lg transition-colors gap-2"
                    >
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                ...
                <div className="flex justify-between text-base sm:text-lg font-bold pt-2 sm:pt-3 border-t-2 border-gray-300">
              ...
              <button
                ...
                disabled={submitting}
                className={`w-full py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg transition-all transform hover:scale-105 shadow-lg ${
                  submitting
